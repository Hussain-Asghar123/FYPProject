...
class TableTennisInfoFragment: Fragment(R.layout.info_fragment) {
    ...
    companion object {
        fun newInstance(match: MatchResponse): TableTennisInfoFragment {
            return TableTennisInfoFragment().apply {
