...
class HockeyInfoFragment : Fragment(R.layout.info_fragment) {

    private var _binding: InfoFragmentBinding? = null
    private val binding get() = _binding!!
    private var matchResponse: MatchResponse? = null
    private val SOCKET_KEY = "HockeyInfoFragment"
    ...
    private fun populateMatchInfo() {
        matchResponse?.let { match ->
            binding.apply {
                ...
                tvBallTypeLabel.text = "Period Duration"
    ...
    companion object {
        fun newInstance(match: MatchResponse) = HockeyInfoFragment().apply {
